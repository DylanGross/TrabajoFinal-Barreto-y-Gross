...
builder.Services.AddSqlServer<TicketsDbContext>(connetionString);
builder.Services.AddHttpContextAccessor();
builder.Services.AddScoped<IFileStorageService, FileStorageService>();
builder.Services.AddScoped<ITareaService, TareaDbService>();
builder.Services.AddScoped<IComentarioService, ComentarioDbService>();
builder.Services.AddScoped<IEstadoService, EstadoDbService>();
